...
function deadZone() {
    ...
    let letnodefined = 'this is letnodefined';
...
function arrowFunctions() {
    ...
    let outputToConsole = (msg) => {console.log(`Using declarative: ${msg}`);}
    ...
    var racers = ['Zero','One','Two','Three'];
    var racerObjects = racers.map((r,index) => (
    	{
    		Name: r,
    		Race: '100m',
    		Pos: index
